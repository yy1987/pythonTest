...
class Database(common.BaseObject):
    ...
    def _list_collections(self, sock_info, subordinate_okay, session=None, **kwargs):
        ...
        if sock_info.max_wire_version > 2:
            ...
            with self.__client._tmp_session(
                ...
                cursor = self._command(
                    sock_info, cmd, subordinate_okay, session=tmp_session)["cursor"]
    ...
    def list_collections(self, session=None, **kwargs):
        ...
        with self.__client._socket_for_reads(
            ...
            return self._list_collections(
                sock_info, subordinate_okay, session=session, **kwargs)
    ...
    def drop_collection(self, name_or_collection, session=None):
        ...
        with self.__client._socket_for_reads(
                ReadPreference.PRIMARY) as (sock_info, subordinate_ok):
            return self._command(
                sock_info, 'drop', subordinate_ok, _unicode(name),
